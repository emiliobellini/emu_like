...
class Sample(object):
    ...
    - generate: generate a sample;
    - resume: after loading a train generator function, if
      it is incomplete, it computes the remaining samples;
    - join: if they are compatible, join two samples and
      return a single one;
