...
#SBATCH --job-name=check_random_points_dataset
...
python /ceph/hpc/home/bellinie/emu_like/scripts/check_data/check_random_points_dataset.py /ceph/hpc/home/bellinie/emu_like/output/cl_100_std.fits -n 20000 -v
