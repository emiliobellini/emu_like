...
diffs = get_modes_to_check(y_all, y_train, y_test, data, y_scaler, y_pca, 540, n_modes, n_modes_to_check=20)
...
diffs = get_modes_to_check(y_all, y_train, y_test, data, y_scaler, y_pca, 400, 500, n_modes_to_check=20)
